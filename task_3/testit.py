...
class App:
    def __init__(self, root):
        ...
        """
        self.model_menu = self.menu_bar.add_cascade("Modèle")
        self.model_var = tk.StringVar(value="hf-internal-testing/tiny-stable-diffusion-torch")
        self.model_menu.add_radiobutton(label="Modèle 1", variable=self.model_var, value="model_1",
                                        )
        self.model_menu.add_radiobutton(label="Modèle 2", variable=self.model_var, value="model_2",
                                        )
        """
